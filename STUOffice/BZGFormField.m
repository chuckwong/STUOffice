...
#define DEFAULT_LEFT_INDICATOR_ACTIVE_ASPECT_RATIO 0.75
#define DEFAULT_NONE_COLOR UIColorFromRGB(0xbebebe)
#define DEFAULT_VALID_COLOR UIColorFromRGB(0x92c459)
#define DEFAULT_INVALID_COLOR UIColorFromRGB(0xFF5449)
                        ...
                        animated:(BOOL)animated
{
    ...
    switch (formFieldState) {
        case BZGFormFieldStateNone: // 2
            self.leftIndicator.backgroundColor = self.leftIndicatorInvalidColor;
            [self.leftIndicator setTitle:@"" forState:UIControlStateNormal | UIControlStateDisabled];
            break;
        case BZGFormFieldStateInvalid: // 0
            self.leftIndicator.backgroundColor = self.leftIndicatorInvalidColor;
            [self.leftIndicator setTitle:(leftIndicatorState) ? @"!" : @""
                                forState:UIControlStateNormal | UIControlStateDisabled];
            break;
        case BZGFormFieldStateValid: // 1
        default:
...
- (void)textFieldTextDidChange:(NSNotification *)notification
{
    ...
    if ([textField isEqual:self.textField] && !textField.text.length) {
        [self updateLeftIndicatorState:BZGLeftIndicatorStateInactive formFieldState:BZGFormFieldStateNone animated:YES];
    }
}
...
//    [self.alertView show];
//}
- (void)setupFormFieldState:(BZGFormFieldState)formFieldState
{
    [self updateLeftIndicatorState:BZGLeftIndicatorStateInactive formFieldState:formFieldState animated:NO];
}
