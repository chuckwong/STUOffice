...
{
    return @{@"汕头大学":@"汕大", @"汕头大学党委":@"党委", @"汕头大学纪委":@"纪委", @"党委宣传部":@"党宣部", @"党政办公室":@"党政办", @"纪委办公室":@"纪委办", @"监察审计处":@"审计处", @"资源管理处":@"管理处", @"党委组织统战部":@"统战部", @"至诚书院":@"至诚院", @"研究生学院":@"研学院", @"继续教育学院":@"继教院", @"长江艺术与设计学院":@"艺术院", @"长江新闻与传播学院":@"新闻院", @"艺术教育中心":@"AEC", @"英语语言中心":@"ELC", @"教师发展中心":@"教发部", @"网络与信息中心":@"网络部", @"校报编辑部":@"校报部", @"学报编辑部":@"学报部", @"华文文学编辑部":@"华文部", @"高等教育研究所":@"高研所", @"招生办公室":@"招生办", @"中心实验室":@"实验室", @"港澳台事务办公室":@"港澳室", @"国际交流合作处":@"国际处", @"发展规划办":@"发规办", @"学生创业中心":@"创业部", @"教师发展与教育评估中心":@"评估部", @"学位评定委员会":@"学评会"};
}
